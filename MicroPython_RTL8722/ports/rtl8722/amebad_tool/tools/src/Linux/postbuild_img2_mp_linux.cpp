...
linux:
g++ -o postbuild_img2_mp_linux src/Linux/postbuild_img2_mp_linux.cpp -static
...
int main(int argc, char *argv[]) {
    ...
    path_arm_none_eabi_gcc.assign(argv[2]);
    
     // 3.1 create map file containing all symbols
    cmdss.clear();
    ...
    fin.close();
     ...
     // 3.2 disassemble and display assembler contents of executable sections
    cmdss.clear();
    ...
    system(cmd.c_str());
#if 0
    // 3.3 check if any forbidden symbols
